  ...
  return (
    <main className="main-content">
      ...
      <section className="stats">
        ...
        <div className="stat pending" onClick={onPendingIssuesClick} style={{ cursor: "pointer" }}>
          <div className="stat-title">Pending Issues</div>
          <div className="stat-value">18</div>
          <div className="stat-desc">-5% from last week</div>
          <span className="stat-icon">🕒</span>
        </div>
        <div className="stat completed" onClick={onCompletedIssuesClick} style={{ cursor: "pointer" }}>
